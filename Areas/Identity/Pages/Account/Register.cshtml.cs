    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, FormatIdentityError(error));
                }
            }
        ...
        private static string FormatIdentityError(IdentityError error)
        {
            return error.Code switch
            {
                "DuplicateUserName" => "This email is already registered. Please log in instead.",
                "InvalidEmail" => "Please provide a valid email address.",
                "PasswordTooShort" => "Password is too short. Use at least 8 characters.",
                "PasswordRequiresNonAlphanumeric" => "Password must include at least one symbol.",
